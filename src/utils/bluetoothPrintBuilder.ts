...
export const buildReceiptJSON = (order: Order) => {
    ...
    add({ type: 2, content: "Sucursal: Centro", bold: 0, align: 0, format: 0 });
    add({ type: 5, content: `Fecha: ${date}`, bold: 0, align: 0, format: 0 });
    add({ type: 4, content: `Hora: ${time}`, bolde: 0, align: 0, format: 0 });
    add({ type: 3, content: `Atendió: Cajero #1`, bold: 0, align: 0, format: 0 });
