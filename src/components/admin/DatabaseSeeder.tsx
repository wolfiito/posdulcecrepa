...
async function seedBebidasCalientes() {
    ...
    const modifierGroups = [
        ...
        { id: "crepa_dulce_topping", name: "Toppings Dulces" }
    ];
    ...
    const modifiers = [
        ...
        {
            id: "te_manzanilla_hinojo_aloe_vera",
            name: "Té de Manzanilla, Hinojo y Aloe Vera",
            price: 0,
            group: "te_sabor",
            trackStock: true
        },
        ...
        {
            id: "te_jengibre_lima",
            name: "Té Jengibre Lima",
            price: 0,
            group: "te_sabor",
            trackStock: true
        },
        {
            id: "te_negro_frutos_rojos",
            name: "Té Negro Frutos Rojos",
            price: 0,
            group: "te_sabor",
            trackStock: true
        },
        ...
        {
            id: "te_blanco_menta",
            name: "Té Blanco y Menta",
            price: 0,
            group: "te_sabor",
            trackStock: true
        },
        {
            id: "te_canela_manzana",
            name: "Té Canela Manzana",
            price: 0,
            group: "te_sabor",
            trackStock: true
        },
        ...
        {
            id: "tisana_pinacoco",
            name: "Tisana Piña - Coco",
            price: 0,
            group: "tisanas_sabor",
            trackStock: false
        },
        {
            id: "tisana_mangomaracuya",
            name: "Tisana Mango - Maracuyá",
            price: 0,
            group: "tisanas_sabor",
            trackStock: false
        },
        {
            id: "tisana_ponche_tradicional",
            name: "Tisana Ponche Tradicional",
            price: 0,
            group: "tisanas_sabor",
            trackStock: false
        },
        {
            id: "tisana_fusion_moras",
            name: "Tisana Fusión Moras",
            price: 0,
            group: "tisanas_sabor",
            trackStock: false
        },
    ...
    const items = [
        {
            ...
            modifierGroups: [],
            variants: [
                { name: "Chico", price: 30, branchPrices: { "wa9igpvRpHkYpT7RPqgu": 35 } },
                { name: "Mediano", price: 35, branchPrices: { "wa9igpvRpHkYpT7RPqgu": 40 } },
                { name: "Grande", price: 40, branchPrices: { "wa9igpvRpHkYpT7RPqgu": 45 } }
            ],
            trackStock: false,
        },

        {
            ...
            category: "bebidas",
            disabledIn: [],
            modifierGroups: ["tipo_leche", "topping_bebida", "topping_extra"],
            variants: [
                { name: "Chico", price: 35, branchPrices: { "wa9igpvRpHkYpT7RPqgu": 40 } },
                { name: "Mediano", price: 40, branchPrices: { "wa9igpvRpHkYpT7RPqgu": 45 } },
                { name: "Grande", price: 45, branchPrices: { "wa9igpvRpHkYpT7RPqgu": 50 } }
            ],
            trackStock: false,
        },

        {
            ...
            modifierGroups: ["tipo_leche", "topping_bebida", "topping_extra"],
            variants: [
                { name: "Chico", price: 40, branchPrices: { "wa9igpvRpHkYpT7RPqgu": 45 } },
                { name: "Mediano", price: 45, branchPrices: { "wa9igpvRpHkYpT7RPqgu": 50 } },
                { name: "Grande", price: 50, branchPrices: { "wa9igpvRpHkYpT7RPqgu": 55 } }
            ],
            trackStock: false,
        },
        ...
        },
        {
            ...
            variants: [
                { name: "Chico", price: 25, branchPrices: { "wa9igpvRpHkYpT7RPqgu": 30 } },
                { name: "Mediano", price: 30, branchPrices: { "wa9igpvRpHkYpT7RPqgu": 35 } },
                { name: "Grande", price: 35, branchPrices: { "wa9igpvRpHkYpT7RPqgu": 40 } }
            ],
            trackStock: false,
        },
        {
...
async function seedBebidasFrias() {
    ...
    const modifiers = [
        ...
        {
            id: "cham_ice_cereza",
            name: "Chamoyada Ice cereza",
            price: 0,
            group: "chamoy_sabor",
            trackStock: false
        },
        {
            id: "cham_ice_mora_azul",
            name: "Chamoyada Ice mora azul",
            price: 0,
            group: "chamoy_sabor",
            trackStock: false
        },
        ...
        },
        {
            ...
            name: "Frappé Matcha",
            price: 20,
            branchPrices: { "ZH1qzEPpDlDgWu8168th": 20, "wa9igpvRpHkYpT7RPqgu": 25 },
            group: "frap_sen_sabor",
            trackStock: false
        },
        {
            id: "fs_galleta_oreo",
            name: "Frappé Galleta oreo",
            price: 0,
            group: "frap_sen_sabor",
            trackStock: false
        },
        ...
        {
            id: "fs_vainilla_francesa",
            name: "Frappé Vainilla francesa",
            price: 0,
            group: "frap_sen_sabor",
            trackStock: false
        },
        ...
        {
            id: "fs_chocolate_blanco",
            name: "Frappé Chocolate blanco",
            price: 0,
            group: "frap_sen_sabor",
            trackStock: false
        },
        {
            id: "fs_chocolate_oscuro",
            name: "Frappé Chocolate oscuro",
            price: 0,
            group: "frap_sen_sabor",
            trackStock: false
        },
        ...
        {
            id: "me_mazapan",
            name: "Malteada Mazapán",
            price: 0,
            group: "malt_esp_sabor",
            trackStock: false
        },
        {
            id: "me_rompope",
            name: "Malteada Rompope",
            price: 0,
            group: "malt_esp_sabor",
            trackStock: false
        },
        ...
        {
            id: "fe_pay_limon",
            name: "Frappé Pay de limón",
            price: 0,
            group: "frap_esp_sabor",
            trackStock: false
        },
        {
            id: "fe_baileys",
        ...
        {
            id: "bt_horchavainilla",
            name: "Bubble Tea Horchavainilla",
            price: 0,
            group: "bubble_sabor",
            trackStock: false
        },
        ...
        {
            id: "bt_dulce_leche",
            name: "Bubble Tea Dulce de leche",
            price: 0,
            group: "bubble_sabor",
            trackStock: false
        },
        {
            id: "bt_cookies_cream",
            name: "Bubble Tea Cookies & cream",
            price: 0,
            group: "bubble_sabor",
            trackStock: false
        },
        {
            id: "bt_coffe_chocolate",
            name: "Bubble Tea Coffe chocolate",
            price: 0,
            group: "bubble_sabor",
            trackStock: false
        },
    ...
    const items = [
        ...
        },
        {
            ...
            disabledIn: [],
            branchPrices: { "wa9igpvRpHkYpT7RPqgu": 75 },
            modifierGroups: ["chamoy_sabor"],
            trackStock: false,
        },
        {
            id: "item_malt_sen",
            name: "Malteada Sencilla",
            category: "bebidas",
            price: 70,
            disabledIn: [],
            branchPrices: { "wa9igpvRpHkYpT7RPqgu": 75 },
            modifierGroups: ["malt_sen_sabor", "tipo_leche", "topping_bebida", "topping_extra"],
            trackStock: false,
        },
        {
            id: "item_malt_esp",
            ...
            price: 90,
            disabledIn: [],
            branchPrices: { "wa9igpvRpHkYpT7RPqgu": 95 },
            modifierGroups: ["malt_esp_sabor", "tipo_leche", "topping_bebida", "topping_extra"],
            trackStock: false,
        },
        {
            id: "item_frap_sen",
            name: "Frappé Sencillo",
            category: "bebidas",
            price: 70,
            disabledIn: [],
            branchPrices: { "wa9igpvRpHkYpT7RPqgu": 75 },
            modifierGroups: ["frap_sen_sabor", "tipo_leche", "topping_bebida", "topping_extra"],
            trackStock: false,
        },
        {
            id: "item_frap_esp",
            ...
            disabledIn: [],
            branchPrices: { "wa9igpvRpHkYpT7RPqgu": 95 },
            modifierGroups: ["frap_esp_sabor", "tipo_leche", "topping_bebida", "topping_extra"],
            trackStock: false,
        },
        {
            id: "item_bubble_tea",
            ...
            price: 95,
            disabledIn: [],
            branchPrices: { "wa9igpvRpHkYpT7RPqgu": 100 },
            modifierGroups: ["bubble_sabor", "bubble_estilo", "tipo_leche", "topping_bebida", "topping_extra"],
            trackStock: false,
        },
        {
            id: "item_esquimo",
            ...
            category: "bebidas",
            price: 60,
            disabledIn: ["ZH1qzEPpDlDgWu8168th"],
            branchPrices: {},
            modifierGroups: ["esquimo_sabor", "esquimo_esencia", "tipo_leche", "topping_bebida", "topping_extra"],
            trackStock: false,
        },
    ];
...
async function seedWafflesHotcakes() {
    ...
    const modifiers = [
        ...
        {
            id: "mod_cereza_almibar",
            name: "Cereza en almíbar",
            price: 0,
            group: "crepa_dulce_base",
            trackStock: false,
            disabledIn: []
        ...
        {
            id: "mod_ext_ksorpresa",
            name: "Kinder Sorpresa",
            price: 30,
            group: "crepa_dulce_extra",
            branchPrices: { "wa9igpvRpHkYpT7RPqgu": 35 },
            trackStock: true,
            disabledIn: []
        },
        {
            ...
            price: 15,
            group: "crepa_dulce_extra",
            branchPrices: { "wa9igpvRpHkYpT7RPqgu": 20 },
            trackStock: true,
            disabledIn: []
        },
        {
            id: "mod_ext_kchocolate",
            name: "Kinder Chocolate",
            price: 10,
            group: "crepa_dulce_extra",
            branchPrices: { "wa9igpvRpHkYpT7RPqgu": 15 },
            trackStock: true,
            disabledIn: []
        },
        {
        ...
        {
            id: "mod_ext_hersheys_blanco",
            name: "Hershey's blanco",
            price: 10,
            group: "crepa_dulce_extra",
            branchPrices: { "wa9igpvRpHkYpT7RPqgu": 15 },
            trackStock: true,
...
async function seedCrepas() {
    ...
    const modifiers = [
        ...
        },
        {
            ...
            trackStock: false,
            disabledIn: [],
            branchPrices: { "ZH1qzEPpDlDgWu8168th": 25, "wa9igpvRpHkYpT7RPqgu": 30 }
        },
        {
            id: "cs_salami",
            name: "Salami",
        ...
        {
            id: "ss_aderezo_mango_habanero",
            name: "Aderezo de mango habanero",
            price: 0,
            group: "crepa_salada_topping",
            trackStock: false,
            disabledIn: []
    ...
    const items = [
        {
            id: "item_chiken_tender",
            name: "Chiken tender",
            category: "crepas",
            price: 100,
            disabledIn: [],
            trackStock: false,
            branchPrices: { "wa9igpvRpHkYpT7RPqgu": 105 }
        },
        {
            id: "item_crepizza",
            name: "Creppizza",
            ...
            disabledIn: [],
            trackStock: false,
            branchPrices: { "wa9igpvRpHkYpT7RPqgu": 85 }
        },
        {
            id: "item_suprema",
            name: "Suprema",
        ...
        {
            id: "item_carnes_frias",
            name: "Carnes frías",
            category: "crepas",
            price: 120,
            disabledIn: [],
            trackStock: false,
            branchPrices: { "wa9igpvRpHkYpT7RPqgu": 125 }
        },
        {
            id: "item_champiqueso",
            name: "Champiqueso",
        ...
        {
            id: "item_dulce_cajeta",
            name: "Dulce de cajeta",
            category: "crepas",
            price: 75,
            disabledIn: [],
            trackStock: false,
            branchPrices: { "wa9igpvRpHkYpT7RPqgu": 80 }
        },
        {
            id: "item_strudel_manzana",
        ...
        {
            id: "item_delicia_casa",
            name: "Delicia de la casa",
            category: "crepas",
            price: 75,
            disabledIn: [],
            trackStock: false,
        ...
        {
            id: "item_dulce_rompope",
            name: "Dulce de rompope",
            category: "crepas",
            price: 75,
            disabledIn: [],
            trackStock: false,
        ...
        {
            id: "item_dulce_platano",
            name: "Dulce de plátano",
            category: "crepas",
            price: 75,
            disabledIn: [],
            trackStock: false,
    ...
    const groups = [
        {
            ...
            items_ref: [
                ...
                "item_frutos_rojos",
                "item_dulce_cajeta",
                "item_strudel_manzana",
                "item_delicia_casa",
                "item_banana_caramel",
                "item_dulce_tentacion",
                "item_dulce_tropical",
                "item_dulce_rompope",
                "item_dulce_nutella",
                "item_dulce_platano",
...
async function seedPostres() {
    const items = [
        ...
        {
            id: "item_uvas_verdes_crema",
            name: "Uvas verdes con crema",
            category: "postres",
            price: 70,
            disabledIn: [],
            branchPrices: { "wa9igpvRpHkYpT7RPqgu": 75 },
        ...
        },
        {
            ...
            price: 35,
            disabledIn: [],
            branchPrices: { "wa9igpvRpHkYpT7RPqgu": 40 },
            trackStock: false,
        },
        {
            id: "item_tapioca",
    ...
    const priceRules = [
        {
            ...
            initialPrice: 60,
            incrementPerIngredient: 10,
            branchInitialPrices: { "wa9igpvRpHkYpT7RPqgu": 65 },
            basePrices: [
                { count: 1, price: 60, branchPrices: { "wa9igpvRpHkYpT7RPqgu": 65 } },
                { count: 2, price: 70, branchPrices: { "wa9igpvRpHkYpT7RPqgu": 75 } },
                { count: 3, price: 75, branchPrices: { "wa9igpvRpHkYpT7RPqgu": 80 } },
            ]
        },
        {
        ...
        },
        {
            ...
            initialPrice: 35,
            incrementPerIngredient: 5,
            branchInitialPrices: { "wa9igpvRpHkYpT7RPqgu": 40 },
            basePrices: []
        },
        {
            id: "rule_mini_hc",
            name: "Regla Mini HotCakes",
            initialPrice: 60,
            incrementPerIngredient: 5,
            branchInitialPrices: { "wa9igpvRpHkYpT7RPqgu": 65 },
            basePrices: []
...
export const DatabaseSeeder: React.FC = () => {
    ...
    if (currentUser?.username != '2310' && currentUser?.id != '2310') {
        return null;
    }
