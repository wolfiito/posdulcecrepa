...
async function seedBebidasCalientes() {
    const modifierGroups = [
        ...
        { id: "topping_extra", name: "Toppings extra" },
        { id: "topping_postres", name: "Toppings Postres" }
    ];
    const modifiers = [
        { id: "te_manzanilla", name: "Té de Manzanilla", price: 0, group: "te_sabor", trackStock: true },
        { id: "te_manzanilla_hinojo_aloe_vera", name: "Té de Manzanilla, Hinojo y Aloe Vera", price: 0, group: "te_sabor", trackStock: true },
        { id: "te_verde_limon", name: "Té Verde Limón", price: 0, group: "te_sabor", trackStock: true },
        { id: "te_jengibre_lima", name: "Té Jengibre Lima", price: 0, group: "te_sabor", trackStock: true },
        { id: "te_negro_frutos_rojos", name: "Té Negro Frutos Rojos", price: 0, group: "te_sabor", trackStock: true },
        { id: "te_limon_hinojo", name: "Té Limón Hinojo", price: 0, group: "te_sabor", trackStock: true },
        { id: "te_blanco_menta", name: "Té Blanco y Menta", price: 0, group: "te_sabor", trackStock: true },
        { id: "te_canela_manzana", name: "Té Canela Manzana", price: 0, group: "te_sabor", trackStock: true },

        { id: "tisana_guayaba", name: "Tisana Guayaba", price: 0, group: "tisanas_sabor", trackStock: false },
        { id: "tisana_pinacoco", name: "Tisana Piña - Coco", price: 0, group: "tisanas_sabor", trackStock: false },
        { id: "tisana_mangomaracuya", name: "Tisana Mango - Maracuyá", price: 0, group: "tisanas_sabor", trackStock: false },
        { id: "tisana_ponche_tradicional", name: "Tisana Ponche Tradicional", price: 0, group: "tisanas_sabor", trackStock: false },
        { id: "tisana_fusion_moras", name: "Tisana Fusión Moras", price: 0, group: "tisanas_sabor", trackStock: false },
        ...
        { id: "top_crema_batida", name: "Crema Batida", price: 0, group: "topping_bebida", trackStock: false },

        { id: "top_dress_nuez", name: "Nuez", price: 0, group: "topping_postres", trackStock: false },
        { id: "top_dress_almendra", name: "Almendra", price: 0, group: "topping_postres", trackStock: false },
        { id: "top_dress_cacahuate", name: "Cacahuate", price: 0, group: "topping_postres", trackStock: false },
        { id: "top_dress_bombones", name: "Bombones", price: 0, group: "topping_postres", trackStock: false },
        { id: "top_dress_krankys", name: "Krankys", price: 0, group: "topping_postres", trackStock: false },
        { id: "top_dress_chocoretas", name: "Chocoretas", price: 0, group: "topping_postres", trackStock: false },
    ];
    const items = [
        ...
        { id: "item_capuchino", name: "Capuchino", category: "bebidas", disabledIn: [], modifierGroups: ["tipo_leche", "topping_bebida", "topping_extra"], variants: [{ name: "Chico", price: 35, branchPrices: { wa9igpvRpHkYpT7RPqgu: 40 } }, { name: "Mediano", price: 40, branchPrices: { wa9igpvRpHkYpT7RPqgu: 45 } }, { name: "Grande", price: 45, branchPrices: { wa9igpvRpHkYpT7RPqgu: 50 } }] },
        { id: "item_latte", name: "Latte", category: "bebidas", disabledIn: [], modifierGroups: ["tipo_leche", "topping_bebida", "topping_extra"], variants: [{ name: "Chico", price: 40, branchPrices: { wa9igpvRpHkYpT7RPqgu: 45 } }, { name: "Mediano", price: 45, branchPrices: { wa9igpvRpHkYpT7RPqgu: 50 } }, { name: "Grande", price: 50, branchPrices: { wa9igpvRpHkYpT7RPqgu: 55 } }] },
        { id: "item_vainilla_latte", name: "Vainilla latte", category: "bebidas", disabledIn: [], modifierGroups: ["tipo_leche", "topping_bebida", "topping_extra"], variants: [{ name: "Chico", price: 40, branchPrices: { wa9igpvRpHkYpT7RPqgu: 45 } }, { name: "Mediano", price: 45, branchPrices: { wa9igpvRpHkYpT7RPqgu: 50 } }, { name: "Grande", price: 50, branchPrices: { wa9igpvRpHkYpT7RPqgu: 55 } }] },
        { id: "item_taro_latte", name: "Taro latte", category: "bebidas", disabledIn: [], modifierGroups: ["tipo_leche", "topping_bebida", "topping_extra"], variants: [{ name: "Chico", price: 40, branchPrices: { wa9igpvRpHkYpT7RPqgu: 45 } }, { name: "Mediano", price: 45, branchPrices: { wa9igpvRpHkYpT7RPqgu: 50 } }, { name: "Grande", price: 50, branchPrices: { wa9igpvRpHkYpT7RPqgu: 55 } }] },
        { id: "item_matcha_latte", name: "Matcha latte", category: "bebidas", disabledIn: [], modifierGroups: ["tipo_leche", "topping_bebida", "topping_extra"], variants: [{ name: "Chico", price: 40, branchPrices: { wa9igpvRpHkYpT7RPqgu: 45 } }, { name: "Mediano", price: 45, branchPrices: { wa9igpvRpHkYpT7RPqgu: 50 } }, { name: "Grande", price: 50, branchPrices: { wa9igpvRpHkYpT7RPqgu: 55 } }] },
        { id: "item_moka", name: "Moka", category: "bebidas", disabledIn: [], modifierGroups: ["tipo_leche", "topping_bebida", "topping_extra"], variants: [{ name: "Chico", price: 40, branchPrices: { wa9igpvRpHkYpT7RPqgu: 45 } }, { name: "Mediano", price: 45, branchPrices: { wa9igpvRpHkYpT7RPqgu: 50 } }, { name: "Grande", price: 50, branchPrices: { wa9igpvRpHkYpT7RPqgu: 55 } }] },
        { id: "item_chocolate", name: "Chocolate", category: "bebidas", disabledIn: [], modifierGroups: ["tipo_leche", "topping_bebida", "topping_extra"], variants: [{ name: "Chico", price: 35, branchPrices: { wa9igpvRpHkYpT7RPqgu: 40 } }, { name: "Mediano", price: 40, branchPrices: { wa9igpvRpHkYpT7RPqgu: 45 } }, { name: "Grande", price: 45, branchPrices: { wa9igpvRpHkYpT7RPqgu: 50 } }] },
        { id: "item_chocolate_blanco", name: "Chocolate blanco", category: "bebidas", disabledIn: [], modifierGroups: ["tipo_leche", "topping_bebida", "topping_extra"], variants: [{ name: "Chico", price: 35, branchPrices: { wa9igpvRpHkYpT7RPqgu: 40 } }, { name: "Mediano", price: 40, branchPrices: { wa9igpvRpHkYpT7RPqgu: 45 } }, { name: "Grande", price: 45, branchPrices: { wa9igpvRpHkYpT7RPqgu: 50 } }] },
...
async function seedBebidasFrias() {
    const modifierGroups = [
        ...
        { id: "esquimo_esencia", name: "Esencias de esquimo" },
    ];

    const modifiers = [
        { id: "sd_rojos", name: "Soda Frutos rojos", price: 0, group: "soda_sabor", trackStock: false },
        { id: "sd_mora", name: "Soda Mora azul", price: 0, group: "soda_sabor", trackStock: false },
        { id: "sd_manzana", name: "Soda Manzana verde", price: 0, group: "soda_sabor", trackStock: false },
        { id: "sd_cereza", name: "Soda Cereza", price: 0, group: "soda_sabor", trackStock: false },
        { id: "sd_maracuya", name: "Soda Maracuya", price: 0, group: "soda_sabor", trackStock: false },
        { id: "sd_mango", name: "Soda Mango", price: 0, group: "soda_sabor", trackStock: false },
        { id: "sd_liche", name: "Soda Liche", price: 0, group: "soda_sabor", trackStock: false },
        { id: "sd_sandia", name: "Soda Sandia", price: 0, group: "soda_sabor", trackStock: false },
        { id: "sd_uva", name: "Soda Uva", price: 0, group: "soda_sabor", trackStock: false },
        ...
        { id: "ms_fresa", name: "Malteada Fresa", price: 0, group: "malt_sen_sabor", trackStock: false },
        { id: "ms_vainilla", name: "Malteada Vainilla", price: 0, group: "malt_sen_sabor", trackStock: false },
        { id: "ms_chocolate", name: "Malteada Chocolate", price: 0, group: "malt_sen_sabor", trackStock: false },
        { id: "ms_cookies_cream", name: "Malteada Cookies & Cream", price: 0, group: "malt_sen_sabor", trackStock: false },

        { id: "fs_taro", name: "Frappé Taro", price: 0, group: "frap_sen_sabor", trackStock: false },
        { id: "fs_capuchino", name: "Frappé Capuchino", price: 0, group: "frap_sen_sabor", trackStock: false },
        { id: "fs_rompompe", name: "Frappé Rompompe", price: 0, group: "frap_sen_sabor", trackStock: false },
        { id: "fs_moka", name: "Frappé Moka", price: 0, group: "frap_sen_sabor", trackStock: false },
        { id: "fs_matcha", name: "Frappé Matcha", price: 0, group: "frap_sen_sabor", trackStock: false },
        { id: "fs_galleta_oreo", name: "Frappé Galleta oreo", price: 0, group: "frap_sen_sabor", trackStock: false },
        { id: "fs_mazapan", name: "Frappé Mazapan", price: 0, group: "frap_sen_sabor", trackStock: false },
        { id: "fs_caramelo", name: "Frappé Caramelo", price: 0, group: "frap_sen_sabor", trackStock: false },
        { id: "fs_horchata", name: "Frappé Horchata", price: 0, group: "frap_sen_sabor", trackStock: false },
        { id: "fs_coco", name: "Frappé Coco", price: 0, group: "frap_sen_sabor", trackStock: false },
        { id: "fs_fresas_crema", name: "Frappé Fresas con crema", price: 0, group: "frap_sen_sabor", trackStock: false },
        { id: "fs_cajeta", name: "Frappé Cajeta", price: 0, group: "frap_sen_sabor", trackStock: false },
        { id: "fs_vainilla_francesa", name: "Frappé Vainilla francesa", price: 0, group: "frap_sen_sabor", trackStock: false },
        { id: "fs_chicle", name: "Frappé Chicle", price: 0, group: "frap_sen_sabor", trackStock: false },
        { id: "fs_chocolate_blanco", name: "Frappé Chocolate blanco", price: 0, group: "frap_sen_sabor", trackStock: false },
        { id: "fs_chocolate_oscuro", name: "Frappé Chocolate oscuro", price: 0, group: "frap_sen_sabor", trackStock: false },
        { id: "fs_cafe", name: "Frappé Café", price: 0, group: "frap_sen_sabor", trackStock: false },
        { id: "fs_yogurt_fresa", name: "Frappé Yogurt de fresa", price: 0, group: "frap_sen_sabor", trackStock: false },
        { id: "fs_pistache", name: "Frappé Pistache", price: 0, group: "frap_sen_sabor", trackStock: false },

        { id: "me_mazapan", name: "Malteada Mazapán", price: 0, group: "malt_esp_sabor", trackStock: false },
        { id: "me_rompope", name: "Malteada Rompope", price: 0, group: "malt_esp_sabor", trackStock: false },
        { id: "me_dulce_leche", name: "Malteada Dulce de leche", price: 0, group: "malt_esp_sabor", trackStock: false },

        { id: "fe_pay_limon", name: "Frappé Pay de limón", price: 0, group: "frap_esp_sabor", trackStock: false },
        { id: "fe_baileys", name: "Frappé Baileys", price: 0, group: "frap_esp_sabor", trackStock: false },
        { id: "fe_nutella", name: "Frappé Nutella", price: 0, group: "frap_esp_sabor", trackStock: false },
        { id: "fe_kahlua", name: "Frappé Kahlua", price: 0, group: "frap_esp_sabor", trackStock: false },

        { id: "bt_taro", name: "Bubble Tea Taro", price: 0, group: "bubble_sabor", trackStock: false },
        { id: "bt_horchavainilla", name: "Bubble Tea Horchavainilla", price: 0, group: "bubble_sabor", trackStock: false },
        { id: "bt_chai", name: "Bubble Tea Chai", price: 0, group: "bubble_sabor", trackStock: false },
        { id: "bt_matcha", name: "Bubble Tea Matcha", price: 0, group: "bubble_sabor", trackStock: false },
        { id: "bt_mazapan", name: "Bubble Tea Mazapan", price: 0, group: "bubble_sabor", trackStock: false },
        { id: "bt_strawberry", name: "Bubble Tea Strawberry", price: 0, group: "bubble_sabor", trackStock: false },
        { id: "bt_dulce_leche", name: "Bubble Tea Dulce de leche", price: 0, group: "bubble_sabor", trackStock: false },
        { id: "bt_cookies_cream", name: "Bubble Tea Cookies & cream", price: 0, group: "bubble_sabor", trackStock: false },
        { id: "bt_coffe_chocolate", name: "Bubble Tea Coffe chocolate", price: 0, group: "bubble_sabor", trackStock: false },
        { id: "bt_horchata_tea", name: "Bubble Tea Horchata tea", price: 0, group: "bubble_sabor", trackStock: false },
        { id: "bt_moka", name: "Bubble Tea Moka", price: 0, group: "bubble_sabor", trackStock: false },
        { id: "bt_gum", name: "Bubble Tea Gum", price: 0, group: "bubble_sabor", trackStock: false },
        { id: "bt_caramel", name: "Bubble Tea Caramel", price: 0, group: "bubble_sabor", trackStock: false },
        ...
        { id: "em_fresa", name: "Esquimo Fresa", price: 0, group: "esquimo_sabor", trackStock: false },
        { id: "em_platano", name: "Esquimo Plátano", price: 0, group: "esquimo_sabor", trackStock: false },

        { id: "em_es_vainilla", name: "Esquimo Vainilla", price: 0, group: "esquimo_esencia", trackStock: false },
        { id: "em_es_chocolate", name: "Esquimo Chocolate", price: 0, group: "esquimo_esencia", trackStock: false },
        { id: "em_es_pistache", name: "Esquimo Pistache", price: 0, group: "esquimo_esencia", trackStock: false },
        { id: "em_es_irlandesa", name: "Esquimo Crema irlandesa", price: 0, group: "esquimo_esencia", trackStock: false },
        { id: "em_es_cafe", name: "Esquimo Café", price: 0, group: "esquimo_esencia", trackStock: false },
    ];
...
async function seedWafflesHotcakes() {
    ...
    const modifiers = [
        ...
        { id: "mod_ext_kdelice", name: "Kinder Delice", price: 15, group: "crepa_dulce_extra", branchPrices: { "ZH1qzEPpDlDgWu8168th": 15, "wa9igpvRpHkYpT7RPqgu": 20 }, trackStock: true, disabledIn: [] },
...
async function seedCrepas() {
    ...
    const groups = [
        ...
        { id: "armar_crepa_dulce", name: "Armar Crepa Dulce", level: 2, parent: "crepas_dulces", rules_ref: "rule_crepa_dulce", base_group: "crepa_dulce_base", extra_groups: ["crepa_dulce_extra"], topping_groups: ["crepa_dulce_topping"] },
        { id: "armar_crepa_salada", name: "Armar Crepa Salada", level: 2, parent: "crepas_saladas", rules_ref: "rule_crepa_salada", base_group: "crepa_salada_base", extra_groups: ["crepa_salada_extra"], topping_groups: ["crepa_salada_topping"] },
    ];
    for (const mg of modifierGroups) await setDoc(doc(db, "modifier_groups", mg.id), mg);
    for (const mod of modifiers) await setDoc(doc(db, "modifiers", mod.id), mod);
    for (const item of items) await setDoc(doc(db, "menu_items", item.id), item);
...
async function seedPostres() {
    const items = [
        { id: "item_fresas_crema", name: "Fresas con crema", category: "postres", price: 70, disabledIn: [], branchPrices: { "ZH1qzEPpDlDgWu8168th": 70, "wa9igpvRpHkYpT7RPqgu": 75 }, topping_groups: ["topping_postres"] },
        { id: "item_duraznos_crema", name: "Duraznos con crema", category: "postres", price: 70, disabledIn: [], branchPrices: { "ZH1qzEPpDlDgWu8168th": 70, "wa9igpvRpHkYpT7RPqgu": 75 }, topping_groups: ["topping_postres"] },
        { id: "item_frutos_rojos_crema", name: "Frutos rojos con crema", category: "postres", price: 70, disabledIn: [], branchPrices: { "ZH1qzEPpDlDgWu8168th": 70, "wa9igpvRpHkYpT7RPqgu": 75 }, topping_groups: ["topping_postres"] },
        { id: "item_uvas_verdes_crema", name: "Uvas verdes con crema", category: "postres", price: 70, disabledIn: [], branchPrices: { "ZH1qzEPpDlDgWu8168th": 70, "wa9igpvRpHkYpT7RPqgu": 75 }, topping_groups: ["topping_postres"] },
...
async function seedPriceRules() {
    ...
    const priceRules = [
        ...
        },
        {
            ...
            basePrices: [
                { count: 1, price: 60, branchPrices: { "ZH1qzEPpDlDgWu8168th": 30, "wa9igpvRpHkYpT7RPqgu": 35 } },
                { count: 2, price: 65, branchPrices: { "ZH1qzEPpDlDgWu8168th": 35, "wa9igpvRpHkYpT7RPqgu": 40 } },
                { count: 3, price: 70, branchPrices: { "ZH1qzEPpDlDgWu8168th": 40, "wa9igpvRpHkYpT7RPqgu": 45 } },
                { count: 4, price: 75, branchPrices: { "ZH1qzEPpDlDgWu8168th": 45, "wa9igpvRpHkYpT7RPqgu": 50 } },
                { count: 5, price: 80, branchPrices: { "ZH1qzEPpDlDgWu8168th": 50, "wa9igpvRpHkYpT7RPqgu": 55 } },
                { count: 6, price: 85, branchPrices: { "ZH1qzEPpDlDgWu8168th": 55, "wa9igpvRpHkYpT7RPqgu": 60 } },
            ]
        },
    ];
